...
<div  id="LogoutModal" class="modal Logout-modal-sm" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-header"><h4><i class="glyphicon glyphicon-log-out"></i>  <?php echo $lang[27] ?><button type="button" class="close" data-dismiss="modal">&times;</button></h4></div>
