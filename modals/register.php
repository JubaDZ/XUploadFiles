...
<form id="register_form" role="form" onsubmit="return false;" class="<?php echo ClassAnimated ?> zoomIn">
  ...
  <div class="form-group">
    <img id="captcha_2" src="ajax/index.php?captcha&background=<?php echo MainColor ?>" onclick="this.src='ajax/index.php?captcha&background=<?php echo MainColor ?>&' + Math.random();" alt="captcha" style="cursor:pointer;">
