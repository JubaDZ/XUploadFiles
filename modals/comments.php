                            ...
                            <div class="col-sm-12 col-md-11">
					            <form id="add_comment_form" role="form" onsubmit="return false;">
									...
									<div class="form-group">
									 ...
									 <div class="form-group">
									    <img id="captcha_6" src="ajax/index.php?captcha&background=<?php echo MainColor ?>" onclick="this.src='ajax/index.php?captcha&background=<?php echo MainColor ?>&' + Math.random();" alt="captcha" style="cursor:pointer;">
